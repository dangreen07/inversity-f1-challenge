...
export default function Heading({pageName}: {pageName: string}) {
    return (
        <div className="flex top-0 bg-white h-24 w-full" role="heading">
            <p className="font-kanit font-semibold non-italic text-4xl flex items-center align-middle h-full pl-5">{pageName}</p>
